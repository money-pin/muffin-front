...
function TopBarLayout() {
  ...
  return (
    <>
      <div
        className={`fixed top-0 left-1/2 z-50 h-[62px] w-full max-w-[var(--max-width-app)] -translate-x-1/2 ${bgClass}`}
      />

      <div
        className={`fixed top-[62px] left-1/2 z-50 w-full max-w-[var(--max-width-app)] -translate-x-1/2 ${bgClass}`}
      >
        <TopBar
          title={topBar.title}
