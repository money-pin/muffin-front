...
export default function BottomNavigation() {
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 h-[80px] w-full max-w-[--max-width-app] bg-white border-t border-neutral-100 flex justify-between items-start px-8 pt-1">
