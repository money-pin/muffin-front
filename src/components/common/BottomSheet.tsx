  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      <section
        ...
        className={`relative z-10 flex max-h-[100dvh] w-full max-w-[390px] flex-col overflow-hidden rounded-t-[20px] bg-neutral-0 outline-none transition-transform duration-300 ease-out ${
