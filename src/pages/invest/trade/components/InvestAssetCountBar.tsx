...
function InvestAssetCountBar({
  ...
  return (
    <div className="fixed bottom-[156px] left-1/2 z-30 flex h-[64px] w-[390px] -translate-x-1/2 items-center justify-between rounded-t-[16px] bg-[var(--color-secondary-100)] px-5 py-3">
      ...
      <div className="flex h-10 w-[131px] items-center justify-between">
        <button
          ...
          className="flex h-10 w-10 items-center justify-center rounded-full bg-[var(--color-neutral-0)] disabled:opacity-40"
          aria-label="수량 감소"
        >
